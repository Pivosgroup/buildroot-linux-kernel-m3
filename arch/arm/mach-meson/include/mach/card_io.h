...
#define EGPIO_GPIOA_ENABLE			CBUS_REG_ADDR(PREG_HGPIO_EN_N)
#define EGPIO_GPIOA_OUTPUT			CBUS_REG_ADDR(PREG_HGPIO_O)
#define EGPIO_GPIOA_INPUT			CBUS_REG_ADDR(PREG_HGPIO_I)

#define EGPIO_GPIOB_ENABLE			CBUS_REG_ADDR(PREG_IGPIO_EN_N)
#define EGPIO_GPIOB_OUTPUT			CBUS_REG_ADDR(PREG_IGPIO_O)
#define EGPIO_GPIOB_INPUT			CBUS_REG_ADDR(PREG_IGPIO_I)

#define EGPIO_GPIOC_ENABLE			CBUS_REG_ADDR(PREG_JGPIO_EN_N)
#define EGPIO_GPIOC_OUTPUT			CBUS_REG_ADDR(PREG_JGPIO_O)
#define EGPIO_GPIOC_INPUT			CBUS_REG_ADDR(PREG_JGPIO_I)
