#ifndef __BOARD_8626M_F04_H
#define __BOARD_8626M_F04_H
...
#define FREESCALE_MEM_SIZE          (SZ_1M*15)
#else
#define FREESCALE_MEM_SIZE          0
#endif
#define FREESCALE_ADDR_START        U_ALIGN(PPMGR_ADDR_END)
#define FREESCALE_ADDR_END          (FREESCALE_ADDR_START+FREESCALE_MEM_SIZE-1)

#define STREAMBUF_MEM_SIZE	(SZ_1M*7)
#define STREAMBUF_ADDR_START	U_ALIGN(FREESCALE_ADDR_END)
