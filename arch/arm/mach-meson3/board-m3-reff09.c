...
static void ar1520_power_on(void)
{
    ...
    //printk("\n\n\n\n\n\n\n ar1520_power_on \n\n");
    //GPIOC_5  -- GPS_RSTN
    clear_mio_mux(0, 1<<15);
    clear_mio_mux(1, 1<<6);
    set_gpio_val(GPIOC_bank_bit0_15(5), GPIOC_bit_bit0_15(5), 0);//reset
