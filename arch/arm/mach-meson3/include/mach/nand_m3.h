...
//	SET_CBUS_REG_MASK(PERIPHS_PIN_MUX_4, (0x1<<11) | (0xff<<14));
	...
	SET_CBUS_REG_MASK((PREG_PAD_GPIO3_O),0x3ffff);	//
	SET_CBUS_REG_MASK((PREG_PAD_GPIO3_EN_N),0x3ffff);	//disable gpio output
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_6,0x3f<<26);
	CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_4,0x1f<<26);
