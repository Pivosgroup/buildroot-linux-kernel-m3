	...
	},
{
		...
		.chip_enable_pad = (AML_NAND_CE0 | ((AML_NAND_CE1&AML_NAND_CE2) << 4)),// | (AML_NAND_CE2 << 8) | (AML_NAND_CE3 << 12)),
		.ready_busy_pad = (AML_NAND_CE1 | (AML_NAND_CE1 << 4)), //| (AML_NAND_CE1 << 8) | (AML_NAND_CE1 << 12)),
		.platform_nand_data = {
			.chip =  {
				.nr_chips = 2,
