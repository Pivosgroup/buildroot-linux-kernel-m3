...
void __init meson_init_irq(void)
{
    ...
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN0_INTR_MASK, 0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN1_INTR_MASK, 0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN2_INTR_MASK, 0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN3_INTR_MASK, 0);

    /* Clear all interrupts */
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN0_INTR_STAT_CLR, ~0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN1_INTR_STAT_CLR, ~0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN2_INTR_STAT_CLR, ~0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN3_INTR_STAT_CLR, ~0);

    /* Set all interrupts to IRQ */
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN0_INTR_FIRQ_SEL, 0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN1_INTR_FIRQ_SEL, 0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN2_INTR_FIRQ_SEL, 0);
    WRITE_CBUS_REG(SYS_CPU_0_IRQ_IN3_INTR_FIRQ_SEL, 0);
...
#ifdef CONFIG_CACHE_L2X0
    /*
     * Early BRESP, D prefetch enabled
     * Non-secure enabled
     * 128kb (16KB/way),
     * 8-way associativity,
     * evmon/parity/share disabled
     * Full Line of Zero enabled
         * Bits:  .101 .... .100 0010 0000 .... .... ...1
     */
    l2x0_init((void __iomem *)IO_PL310_BASE, 0x5c420001, 0xff800fff);
#endif
}
