...
extern void osddev_get_enforce_progressive(u32 index, u32 *enforce_progressive);
extern void osddev_set_enforce_progressive(u32 index, u32 enforce_progressive);
