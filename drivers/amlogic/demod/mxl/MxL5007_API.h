...
**
******************************************************************************/
MxL_ERR_MSG MxL_RFSynth_Lock_Status(MxL5007_TunerConfigS* , int * isLock);
...
**
******************************************************************************/
MxL_ERR_MSG MxL_REFSynth_Lock_Status(MxL5007_TunerConfigS* , int * isLock);

int MxL_I2C_Write(long I2C_adap, char* pArray, int count);
int MxL_I2C_Read (long I2C_adap, int Addr, char* mData);
