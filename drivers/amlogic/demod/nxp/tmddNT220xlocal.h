...
#define NT220x_DD_MAJOR_VER   4 // Minor protocol change - Specification change required
#define NT220x_DD_MINOR_VER   5 // Software update - No protocol change - No specification change required

#define NT220x_POWER_LEVEL_MIN  40
#define NT220x_POWER_LEVEL_MAX  110

#define NT220x_MAX_UNITS                  4 //suppport 4 tuners //2
...
#define NT220x_RFCAL_COEFFS_ROW (8)
	...
	extern tmErrorCode_t tmddNT220xAGC1_Adapt(tmUnitSelect_t tUnit);
