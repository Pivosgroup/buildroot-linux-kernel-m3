...
{    
    ...
    if(err == TM_OK)
	{
        ...
        {
            /* Set LPF */
            err = tmddNT220xSetLP_FC(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].LPF);
        ...
        {
            /* Set LPF Offset */
            err = tmddNT220xSetLP_FC_Offset(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].LPF_Offset);
        ...
        {
            /* Set IF Gain */
            err = tmddNT220xSetIF_Level(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].IF_Gain);
        ...
        {
            /* Set IF Notch */
            err = tmddNT220xSetIF_ATSC_Notch(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].IF_Notch);
        ...
        {
            /* Set DC Notch */
            err = tmddNT220xSetIF_Notch(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].DC_Notch);
        ...
        {
            /* Set AGC1 LNA Top */
            err = tmddNT220xSetAGC1_TOP(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC1_LNA_TOP);
        ...
        {
            /* Set AGC2 RF Top */
            err = tmddNT220xSetAGC2_TOP(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC2_RF_Attenuator_TOP);
        ...
        if(err == TM_OK)
        {
            ...
            {
                err = tmddNT220xSetRFAGC_Top(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC3_RF_AGC_TOP_Low_band);
                tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddNT220xSetRFAGC_Top(0x%08X) failed.", tUnit));
            }
            else
            {
                err = tmddNT220xSetRFAGC_Top(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC3_RF_AGC_TOP_High_band);
                tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddNT220xSetRFAGC_Top(0x%08X) failed.", tUnit));
            }
        }
        ...
        if(err == TM_OK)
        {
            ...
            err = tmddNT220xSetIR_Mixer_Top(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC4_IR_Mixer_TOP);
        ...
        {
            /* Set AGC5 IF AGC Top */
            err = tmddNT220xSetAGC5_TOP(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC5_IF_AGC_TOP);
        ...
        {
            /* Set AGC3 Adapt */
            err = tmddNT220xSetPD_RFAGC_Adapt(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC3_Adapt);
        ...
        {
            /* Set AGC3 Adapt TOP */
            err = tmddNT220xSetRFAGC_Adapt_TOP(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC3_Adapt_TOP);
        ...
        {
            /* Set AGC5 Atten 3dB */
            err = tmddNT220xSetRF_Atten_3dB(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC5_Atten_3dB);
        ...
        if(err == TM_OK)
        {
            ...
            err = tmddNT220xSetAGC5_Ana(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].AGC5_Detector_HPF);
        ...
        {
            /* Set AGCK Mode */
            err = tmddNT220xSetAGCK_Mode(tUnit, (UInt8)(pObj->Std_Array[pObj->StandardMode].GSK&0x03));
            tmASSERTExT(err, TM_OK, (DEBUGLVL_ERROR, "tmddNT220xSetAGCK_Mode(0x%08X) failed.", tUnit));

            err = tmddNT220xSetAGCK_Step(tUnit, (UInt8)((pObj->Std_Array[pObj->StandardMode].GSK&0x0C)>>2));
        ...
        if(err == TM_OK)
        {
            ...
            err = tmddNT220xSetPSM_StoB(tUnit, (UInt8)pObj->Std_Array[pObj->StandardMode].H3H5_VHF_Filter6);
