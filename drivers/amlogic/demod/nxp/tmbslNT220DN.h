...
#ifndef _TMBSL_NT220DN_H
#define _TMBSL_NT220DN_H
...
#define NT220x_ERR_BAD_VERSION        (NT220x_ERR_COMP + 0x0003)
    ...
    typedef enum _tmNT220xPowerState_t {
        tmNT220x_PowerNormalMode = 0,                                 /* Device normal mode */
    ...
    typedef enum _tmNT220xStandardMode_t {
        ...
        tmNT220x_ScanXpress,                          /* ScanXpress */
...
#define tmNT220x_AGC3_RF_AGC_TOP_FREQ_LIM 291000000
    ...
    typedef enum _tmNT220xAGC3_Adapt_TOP_t {
        tmNT220x_AGC3_Adapt_TOP_0_Step = 0,              /* same level as AGC3 TOP  */
        tmNT220x_AGC3_Adapt_TOP_1_Step,                  /* 1 level below AGC3 TOP  */
        tmNT220x_AGC3_Adapt_TOP_2_Step,                  /* 2 level below AGC3 TOP  */
        tmNT220x_AGC3_Adapt_TOP_3_Step,                  /* 3 level below AGC3 TOP  */
    ...
    typedef enum _tmNT220xRFFilterRobustness_t {
        ...
        tmNT220xRFFilterRobustness_Error,
