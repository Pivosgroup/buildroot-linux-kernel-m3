...
#define ACD_REG_29                                      ((ACD_BASE_ADD+0x29)<<2)
    ...
    #define REG_4F_MOTION_ADDR_OFFSET_BIT  0
...
// ******** ANTI-ALIAS FILTER -- YPBPR & CVBS **********************************

#define TVFE_AAFILTER_CTRL1                             ((TOP_BASE_ADD+0x77)<<2)
    #define AAFILTER_BYPASS_BIT             18
    #define AAFILTER_BYPASS_WID             2
    #define AAFILTER_SCALE_BIT              16
    #define AAFILTER_SCALE_WID              1
    #define AAFILTER_ALPHA0_BIT             8
    #define AAFILTER_ALPHA0_WID             8
    #define AAFILTER_ALPHA1_BIT             0
    #define AAFILTER_ALPHA1_WID             8

#define TVFE_AAFILTER_CTRL2                             ((TOP_BASE_ADD+0x78)<<2)
    #define AAFILTER_ALPHA2_BIT             24
    #define AAFILTER_ALPHA2_WID             8
    #define AAFILTER_ALPHA3_BIT             16
    #define AAFILTER_ALPHA3_WID             8
    #define AAFILTER_ALPHA4_BIT             8
    #define AAFILTER_ALPHA4_WID             8
    #define AAFILTER_ALPHA5_BIT             0
    #define AAFILTER_ALPHA5_WID             8
...
#define CVD2_CHROMA_DTO_INCREMENT_31_24                 ((CVD_BASE_ADD+0x18)<<2)
    #define CDTO_INC_31_24_BIT              0
    #define CDTO_INC_31_24_WID              8
