...
/** TLV type : ARP filter */
#define TLV_TYPE_ARP_FILTER         (PROPRIETARY_TLV_BASE_ID + 21)
...
/** HostCmd_DS_RX_DATA_PAUSE */
typedef struct _HostCmd_DS_RX_DATA_PAUSE
{
    /** Action */
    t_u16 action;
    /** Reserved field */
...
/** TLV type : BSS Status */
#define TLV_TYPE_BSS_STATUS              (PROPRIETARY_TLV_BASE_ID + 147)
...
typedef struct MLAN_PACK_START _HostCmd_DS_COMMAND
{
    ...
    union
    {
        ...
        HostCmd_DS_RX_DATA_PAUSE data_pause;
