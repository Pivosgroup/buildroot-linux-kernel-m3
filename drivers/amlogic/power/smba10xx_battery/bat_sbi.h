 ...
 *********************************************************************
 */
#ifndef __BAT_SBI_H__
#define __BAT_SBI_H__
/**
 * BatteryMode.
 * 
 ...
 * Method declare
 */
extern int Temperature(unsigned short *temperature);
extern int Voltage(unsigned short *voltage);
extern int Current(unsigned short *tmp_current);
extern int RelativeStateOfCharge(unsigned short *rsoc);
extern int RemainingCapacity(unsigned short *capacity);
extern int FullChargeCapacity(unsigned short *capacity);
extern int AverageTimeToEmpty(unsigned short *time);
extern int BatteryStatus(unsigned short *status);
extern int ChargingCurrent(unsigned short *tmp_current);
extern int ChargingVoltage(unsigned short *voltage);
extern int DesignCapacity(unsigned short *capacity);
extern int DesignVoltage(unsigned short *voltage);
extern int ManufactureDate(unsigned short *date);
extern int SerialNumber(unsigned short *number);
extern int ManufactureName(unsigned char *name);
extern int DeviceName(unsigned char *name);
extern int DeviceChemistry(unsigned char *chemistry);
extern int AverageVoltage(unsigned short *voltage);
extern int AverageCurrent(short *tmp_current);
extern int RunTimeToEmpty(unsigned short *minute);
extern int StateOfHealth(unsigned short *health);
