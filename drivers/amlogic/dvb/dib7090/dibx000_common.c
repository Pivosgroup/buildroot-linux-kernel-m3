...
static int dibx000_comm_debug;
module_param(dibx000_comm_debug, int, 0644);
MODULE_PARM_DESC(dibx000_comm_debug, "turn on debugging (default: 0)");

#define dprintk(args...) do { if (dibx000_comm_debug) { printk(KERN_DEBUG "DiBX000: "); printk(args); printk("\n"); } } while (0)
